...
export async function generateDays(brief, plan, fromDay, toDay, onEvent, note) {
  const dates = [];
...
Cette journée a déjà été composée une fois et ne convient pas. Voici ce que le voyageur en dit : « ${note} ». Réécris-la entièrement en tenant compte de cette remarque, et ne reprends aucune des étapes précédentes telles quelles.`
      : ""
  }`;
