...
export const LEGAL = {
  mentions: ["Mentions légales", `Éditeur : ${E.name}, ${E.legalForm.toLowerCase()}, immatriculé sous le SIREN ${E.siren} (SIRET du siège ${E.siret}), TVA intracommunautaire ${E.vat}, code d'activité ${E.ape}, immatriculé le ${E.created}. Convention collective applicable : ${E.convention}. Contact : ${E.email}. Directeur de la publication : le représentant légal de l'entreprise. Hébergeur du site : Vercel Inc., 440 N Barranca Ave #4133, Covina, CA 91723, États-Unis.`],
