...
export const PRAYER={kl:{Fajr:"05:52",Dhuhr:"13:03",Asr:"16:14",Maghrib:"19:07",Isha:"20:16"},
 pen:{Fajr:"05:56",Dhuhr:"13:07",Asr:"16:20",Maghrib:"19:11",Isha:"20:20"},
 lgk:{Fajr:"05:58",Dhuhr:"13:09",Asr:"16:24",Maghrib:"19:13",Isha:"20:22"}};
...
{n:1,c:"fly",d:"sam. 03 oct",t:"Paris → Kuala Lumpur",items:[
 ...
 {id:"d1b",t:"18:05",k:"transfer",f:"Vol Paris → Doha",s:"QR 40 · 6 h 35 · repas halal certifié à bord",dur:"6 h 35"},
...
{n:2,c:"kl",d:"dim. 04 oct",t:"Arrivée en douceur",items:[
 ...
 {id:"d2e",t:"20:00",k:"food",f:"Dîner léger — food court halal, Suria KLCC",s:"Nasi goreng, satay · sans réservation",cost:"≈ 12 €",halal:true}]},
{n:3,c:"kl",d:"lun. 05 oct",t:"Grottes, islam & saveurs",items:[
 {id:"d3a",t:"09:00",k:"food",f:"Petit-déjeuner à l'hôtel",s:"Buffet avec coin halal",halal:true},
 {id:"d3b",t:"10:00",k:"sight",f:"Grottes de Batu",s:"272 marches · épaules couvertes",dur:"2 h",cost:"Gratuit",out:true,crowd:"busy",travel:{m:28,by:"car"},
 ...
 {id:"d3d",t:"14:30",k:"sight",f:"Musée des arts islamiques",s:"Coupoles, calligraphies · climatisé",dur:"2 h",cost:"8 €",crowd:"low",travel:{m:15,by:"car"}},
 {id:"d3e",t:"16:45",k:"sight",f:"Masjid Negara — mosquée nationale",s:"Prière de l'Asr sur place · abayas prêtées",dur:"45 min",tag:"mosquee",travel:{m:6,by:"walk"},
  why:"À 5 min à pied du musée — l'Asr est à 16:14 à KL (estimation)."},
 {id:"d3f",t:"20:00",k:"food",f:"Dîner — Kampung Baru",s:"Le village malais historique · 100 % halal",cost:"≈ 10 €",halal:true,out:true,crowd:"busy",travel:{m:14,by:"car"},
  why:"Nasi lemak légendaire — au cœur de votre profil « gastronomie halal »."}]},
...
{n:5,c:"pen",d:"mer. 07 oct",t:"Cap sur Penang",items:[
 ...
 {id:"d5e",t:"19:30",k:"food",f:"Nasi kandar — Line Clear",s:"Institution halal de Penang depuis 1947",cost:"≈ 8 €",halal:true,out:true,crowd:"busy",
  why:"File d'attente = bon signe. Le poulet madras est un incontournable."}]},
{n:6,c:"pen",d:"jeu. 08 oct",t:"George Town patrimoine",items:[
 {id:"d6a",t:"09:00",k:"sight",f:"Balade patrimoine UNESCO",s:"Shophouses, mosquée Kapitan Keling, temples · ~5 km",dur:"3 h",out:true,crowd:"mod",
  why:"À pied — le centre historique se déguste lentement."},
 {id:"d6b",t:"12:30",k:"food",f:"Assam laksa au marché",s:"Version poisson · vérifier le stand halal",cost:"≈ 6 €",halal:true,travel:{m:6,by:"walk"}},
 ...
 {id:"d6e",t:"19:30",k:"food",f:"Dîner — Kapitan, Little India",s:"Briyani & tandoori · certifié halal",cost:"≈ 11 €",halal:true,crowd:"busy"}]},
{n:7,c:"pen",d:"ven. 09 oct",t:"Collines et temples",items:[
 ...
 {id:"d7b",t:"12:30",k:"sight",f:"Temple Kek Lok Si",s:"Le plus grand de Malaisie · visite culturelle",dur:"1 h 30",cost:"2 €",out:true,crowd:"mod",travel:{m:15,by:"car"}},
 {id:"d7c",t:"15:30",k:"rest",f:"Piscine & sieste",s:"Retour à George Town",travel:{m:25,by:"car"}},
 {id:"d7d",t:"18:40",k:"sight",f:"Coucher de soleil — Chew Jetty",s:"Ponton face à l'ouest · Maghrib à 19:11",dur:"45 min",out:true,tag:"sunset",crowd:"mod",travel:{m:10,by:"walk"},
  why:"Le soleil tombe dans le détroit pile avant le dîner — votre moment à deux."},
 {id:"d7e",t:"20:00",k:"food",f:"Hawkers halal — Padang Kota Lama",s:"Pasembur, mee goreng, coco glacé",cost:"≈ 9 €",halal:true,travel:{m:8,by:"walk"}}]},
{n:8,c:"lgk",d:"sam. 10 oct",t:"L'île aux aigles",items:[
 ...
 {id:"d8f",t:"19:30",k:"food",f:"Dîner pieds dans le sable",s:"Grillades halal du resort · 0 % alcool",cost:"≈ 20 €",halal:true,tag:"sunset"}]},
{n:9,c:"lgk",d:"dim. 11 oct",t:"Au-dessus de la canopée",items:[
 ...
 {id:"d9b",t:"12:30",k:"food",f:"Déjeuner — Oriental Village",s:"Stands halal · vue montagne",cost:"≈ 10 €",halal:true},
 {id:"d9c",t:"15:00",k:"beach",f:"Plage & baignade",dur:"2 h 30",out:true,travel:{m:30,by:"car"}},
 {id:"d9d",t:"19:00",k:"food",f:"Grillades au bord de l'eau",s:"Poissons du jour · halal",cost:"≈ 16 €",halal:true,tag:"sunset"}]},
{n:10,c:"lgk",d:"lun. 12 oct",t:"Mangroves et lenteur",items:[
 ...
 {id:"d10b",t:"13:30",k:"food",f:"Ferme aquacole de Kilim",s:"Fruits de mer halal, au-dessus de l'eau",cost:"≈ 15 €",halal:true},
 {id:"d10c",t:"16:00",k:"activity",f:"Spa en duo",s:"90 min · au resort",cost:"48 €",resa:true,travel:{m:40,by:"car"}},
 {id:"d10d",t:"20:00",k:"food",f:"Dîner romantique bord de mer",s:"Table sur le sable · sans alcool",cost:"≈ 24 €",halal:true,tag:"sunset"}]},
{n:11,c:"lgk",d:"mar. 13 oct",t:"Journée libre, presque",items:[
 {id:"d11a",t:"—",k:"rest",f:"Matinée libre — piscine",s:"Aucun réveil programmé"},
 {id:"d11b",t:"12:30",k:"food",f:"Déjeuner — Siti Fatimah",s:"Buffet malais halal réputé de l'île",cost:"≈ 8 €",halal:true,travel:{m:20,by:"car"}},
 {id:"d11c",t:"14:30",k:"rest",f:"Temps libre — Kuah duty-free",s:"Chocolats à rapporter · ou simplement rien",travel:{m:15,by:"car"}},
 {id:"d11d",t:"17:30",k:"activity",f:"Croisière familiale au coucher du soleil",s:"3 h · dîner halal à bord · sans alcool",cost:"55 €",resa:true,out:true,crowd:"mod",tag:"sunset",
  why:"La dernière vraie soirée — la mer d'Andaman en spectacle, Maghrib à 19:13."}]},
{n:12,c:"fly",d:"mer. 14 oct",t:"Retour vers Paris",items:[
 ...
 {id:"d12e",t:"16:55",k:"transfer",f:"Vol KUL → Doha → Paris",s:"Arrivée CDG 06:55 le 15 oct · repas halal à bord",dur:"16 h 30"}]}
];
...
export const DAY4A=[
 ...
 {id:"d4b",t:"12:00",k:"food",f:"Déjeuner — Masjid India",s:"Quartier 100 % halal · roti canai, teh tarik",cost:"≈ 7 €",halal:true},
 {id:"d4c",t:"13:15",k:"sight",f:"Masjid Jamek",s:"Prière du Dhuhr · la plus ancienne mosquée de KL",dur:"45 min",tag:"mosquee",travel:{m:6,by:"walk"}},
 ...
 {id:"d4g",t:"21:15",k:"food",f:"Dîner tardif — Saloma, bord de rivière",s:"Cuisine malaise halal · spectacle culturel",cost:"≈ 18 €",halal:true,travel:{m:8,by:"walk"}}];
...
export const DAY4B=[
 ...
 {id:"d4i",t:"12:15",k:"food",f:"Déjeuner — Masjid India",s:"Roti canai, teh tarik · à couvert",cost:"≈ 7 €",halal:true,travel:{m:10,by:"car"}},
 {id:"d4j",t:"13:20",k:"sight",f:"Masjid Jamek",s:"Prière du Dhuhr · à l'abri",dur:"45 min",tag:"mosquee",travel:{m:5,by:"walk"}},
 ...
 {id:"d4n",t:"21:15",k:"food",f:"Dîner tardif — Saloma",s:"Cuisine malaise halal",cost:"≈ 18 €",halal:true,travel:{m:8,by:"walk"}}];
...
export const FLIGHTS=[
 {id:"qr",al:"Qatar Airways",code:"QR",col:"#5C0632",dep:"15:55",arr:"14:20",plus:1,dur:"16 h 25",stops:"1 escale · DOH 1 h 50",price:670,score:93,tag:"Meilleur équilibre",
  dims:[["Prix",86],["Durée",90],["Confort",92],["Horaires",95],["Fiabilité",96],["Repas halal certifié",100]]},
 {id:"sq",al:"Singapore Airlines",code:"SQ",col:"#1C3F94",dep:"12:00",arr:"10:20",plus:1,dur:"16 h 20",stops:"1 escale · SIN 1 h 30",price:745,score:90,tag:"Confort cabine",
  dims:[["Prix",72],["Durée",90],["Confort",99],["Horaires",86],["Fiabilité",92],["Repas halal certifié",100]]},
 {id:"ek",al:"Emirates",code:"EK",col:"#7A1F1F",dep:"21:30",arr:"19:15",plus:1,dur:"15 h 45",stops:"1 escale · DXB 2 h 05",price:718,score:89,tag:"Le plus rapide",
  dims:[["Prix",78],["Durée",94],["Confort",96],["Horaires",70],["Fiabilité",88],["Repas halal certifié",100]]},
 {id:"tk",al:"Turkish Airlines",code:"TK",col:"#B0243A",dep:"11:35",arr:"11:05",plus:1,dur:"17 h 30",stops:"1 escale · IST 2 h 40",price:604,score:84,tag:"Le moins cher",
  dims:[["Prix",98],["Durée",74],["Confort",84],["Horaires",84],["Fiabilité",78],["Repas halal certifié",100]]}
];

export const AREAS=[
 {n:1,name:"KLCC",tag:"Idéal 1er séjour",top:true,rows:[["Ambiance","Verticale, verte, apaisée"],["Transports","LRT + tout à pied"],["Halal","Food courts partout"],["Prix","€€–€€€"],["Atout","4 activités prévues à < 15 min"]]},
 {n:2,name:"Bukit Bintang",tag:"Le plus gourmand",rows:[["Ambiance","Électrique, commerçante"],["Transports","Monorail + MRT"],["Halal","Nombreuses adresses certifiées"],["Prix","€–€€€"],["Atout","Tout se fait à pied le soir"]]},
 {n:3,name:"Masjid India / Chinatown",tag:"Meilleur rapport",rows:[["Ambiance","Historique, brute, vivante"],["Transports","MRT Pasar Seni"],["Halal","Quartier Masjid India 100 % halal"],["Prix","€–€€"],["Atout","Vieux KL à pied"]]}
];
...
export const HOTELS=[
 {id:"h1",city:"kl",name:"Traders Hotel",area:"KLCC",sky:"gSky1",rating:4.6,rev:"2 840",price:98,nights:4,
  ...
  why:["Vue directe sur les tours Petronas","Petit-déjeuner avec large choix halal","Pratique pour 4 activités planifiées","Dans votre budget (≈ 98 €/nuit)"],
 ...
 {id:"h2",city:"pen",name:"Campbell House",area:"George Town",sky:"gSky2",rating:4.8,rev:"1 120",price:72,nights:3,
  ...
  why:["Maison de 1903 restaurée — cachet rare","≈ 72 €/nuit : sous votre moyenne cible","Petit-déjeuner halal sur demande (à confirmer)","Rues calmes la nuit malgré le centre"],
 ...
 {id:"h3",city:"lgk",name:"Dash Resort",area:"Pantai Cenang",sky:"gSky3",rating:4.4,rev:"1 960",price:84,nights:4,
  ...
  why:["Les pieds dans le sable pour 4 nuits","Restaurant de plage halal · 0 % alcool en salle famille","Spa sur place (réservé jour 10)","≈ 84 €/nuit — équilibre confort/prix"],
...
export const RESTOS=[
 {id:"m1",city:"kl",name:"Nasi Lemak Wanjo — Kampung Baru",cui:"Malais traditionnel",p:"≈ 4 €",sky:"gSky3",tags:["halal","budget","local"],
  why:"Le nasi lemak de référence de KL, dans le village malais historique. File rapide, service continu."},
 {id:"m2",city:"kl",name:"Restoran Rebung Chef Ismail",cui:"Buffet malais authentique",p:"≈ 15 €",sky:"gSky1",tags:["halal","famille","local"],
  why:"60 plats kampung en buffet, du rendang au cendol — la Malaisie des grands-mères, certifiée halal."},
 ...
 {id:"m4",city:"pen",name:"Line Clear Nasi Kandar",cui:"Nasi kandar mamak",p:"≈ 8 €",sky:"gSky3",tags:["halal","budget","local"],
  why:"Institution halal depuis 1947, ouverte tard. Le poulet madras arrosé de trois sauces : incontournable."},
 {id:"m5",city:"pen",name:"Kapitan — Little India",cui:"Briyani & tandoori",p:"≈ 11 €",sky:"gSky1",tags:["halal","famille"],
  why:"Certifié halal, immense carte indienne-musulmane, claypot briyani réputé — et ça sert jusqu'à minuit."},
 ...
 {id:"m7",city:"lgk",name:"Siti Fatimah",cui:"Buffet malais de l'île",p:"≈ 8 €",sky:"gSky3",tags:["halal","budget","local","famille"],
  why:"L'adresse où déjeunent les familles de Langkawi : 50 plats malais halal servis à la louche."},
 {id:"m8",city:"lgk",name:"Dîner sur le sable — Pantai Cenang",cui:"Grillades & fruits de mer",p:"≈ 20 €",sky:"gSky3",tags:["halal","sunset","couple"],
  why:"Table posée sur la plage face à l'ouest : le Maghrib est à 19:13 — le soleil tombe pendant les entrées."},
 {id:"m9",city:"lgk",name:"Ferme aquacole de Kilim",cui:"Fruits de mer halal",p:"≈ 15 €",sky:"gSky2",tags:["halal","local"],
  why:"Poissons élevés sous vos pieds, cuisinés à la commande au-dessus de la mangrove. Accès en bateau."},
 {id:"m10",city:"lgk",name:"Croisière-dîner — mer d'Andaman",cui:"Buffet halal à bord · sans alcool",p:"≈ 55 €",sky:"gSky1",tags:["halal","sunset","couple","famille"],
  why:"Déjà réservée au jour 11 : trois heures sur l'eau, buffet halal, zéro alcool à bord — et le Maghrib en pleine mer."}
];

export const RTAGS={halal:"Halal",vegan:"Végane",sunset:"Coucher de soleil",budget:"Petit prix",famille:"En famille",local:"Vécu local",couple:"En amoureux",sain:"Sain"};

export const RFILTERS=[["tous","Tous"],["halal","Certifié halal"],["vegan","Options véganes"],["sunset","Vue sunset"],["budget","Petit budget"],["famille","En famille"],["local","Local authentique"]];
...
export const BUDGET=[
 ...
 {l:"Repas (tout halal)",col:"linear-gradient(90deg,#FF8A5C,#F0813C)",amt:300,conf:false}
];
...
export const CHECKGROUPS=[
 ...
 ["Sur place",["Tenue couvrante + foulard pour les mosquées","Chaussures faciles à retirer (temples, mosquées)","Adaptateur type G (prises UK)","Photo du tapis de bagages & de la voiture de loc"]]
];

export const PACK=[
 ["Vêtements",[["7 hauts respirants","lin & coton — lavage possible à l'hôtel"],["2 pantalons légers + 2 shorts","genoux couverts pour les mosquées"],["Tenue modeste + foulard","Masjid Negara & Masjid Jamek"],["Maillots de bain × 2","piscines & plage de Cenang"],["Sandales + baskets légères","272 marches à Batu Caves"]]],
...
export const SCENARIOS=[
 {key:"ess",label:"Essentiel",score:88,tagline:"Le même voyage, dépouillé du superflu.",price:2620,
  lines:["Turkish Airlines (le tarif malin, escale plus longue)","Hôtels simples bien placés, mêmes quartiers","Street food halal à chaque repas","Activités payantes limitées aux trois essentielles"]},
 {key:"eq",label:"Équilibre",score:94,reco:true,tagline:"Notre recommandation — celle du plan détaillé.",price:3185,
  lines:["Qatar Airways, repas halal certifié","Traders · Campbell House · Dash Resort","Street food ET belles tables halal","Kayak Kilim, SkyCab, spa duo, croisière sans alcool"]},
 {key:"plus",label:"Confort +",score:91,tagline:"Les mêmes journées, avec plus de douceur.",price:3480,
  lines:["Singapore Airlines, cabine primée","Chambres vue mer / étages élevés","Transferts privés à chaque étape","Spa 2 séances + croisière en catamaran privé (sans alcool)"]}
];

export const AIRPORTS=[["CDG","Paris — Charles de Gaulle","Vols directs et longs-courriers"],["ORY","Paris — Orly","Pratique depuis le sud de Paris"],["LYS","Lyon — Saint-Exupéry","Avec une courte correspondance"],["MRS","Marseille — Provence","Avec une courte correspondance"]];

export const DEST_SUGG=[["Malaisie","Démo complète · halal par défaut"],["Turquie","Istanbul, Cappadoce, côte égéenne"],["Maroc","Marrakech, Atlas, océan"],["Indonésie","Selon la saison des pluies"],["Oman","Fjords, wadis et désert"]];

export const GALS=[
 {key:"bali",city:"Bali",country:"Indonésie",img:"/assets/hero-bali.jpg",temp:"29° en oct.",aff:"Affluence modérée",ideal:"Idéal 10-14 jours"},
 {key:"tokyo",city:"Tokyo",country:"Japon",img:"/assets/hero-tokyo.jpg",temp:"22° en oct.",aff:"Momiji tout proche",ideal:"Idéal 8-12 jours"},
 {key:"marrakech",city:"Marrakech",country:"Maroc",img:"/assets/hero-marrakech.jpg",temp:"27° en oct.",aff:"Douceur parfaite",ideal:"Idéal 4-7 jours"},
 {key:"lisbonne",city:"Lisbonne",country:"Portugal",img:"/assets/hero-lisbonne.jpg",temp:"23° en oct.",aff:"Basse saison douce",ideal:"Idéal 4-6 jours"},
 {key:"newyork",city:"New York",country:"États-Unis",img:"/assets/hero-newyork.jpg",temp:"17° en oct.",aff:"Été indien",ideal:"Idéal 5-8 jours"}
];

export const CITYPHOTO={kl:"/assets/hero-tokyo.jpg",pen:"/assets/hero-marrakech.jpg",lgk:"/assets/hero-bali.jpg",fly:"/assets/hero-lisbonne.jpg"};
...
export const photoOf = (c) => CITYPHOTO[c] || "/assets/hero-bali.jpg";
...
export const STOPS = [
  { k: "kl", name: "Kuala Lumpur", n: "4 nuits", x: 150, y: 322 },
  { k: "pen", name: "Penang", n: "3 nuits", x: 104, y: 168 },
  { k: "lgk", name: "Langkawi", n: "4 nuits", x: 62, y: 92 },
];
export const SCOREROWS = [
  ...
  ["Curation vérifiée", 99, "Tables certifiées, prières intégrées"],
];
export const TABS = [
...
export const STYLE_CARDS = [
  ...
  ["Culture & mosquées", "Patrimoine, musées, quartiers historiques, belles mosquées.", "mosque"],
  ["Aventure", "Reliefs, kayak, lever tôt, sortir des routes.", "compass"],
  ["Gastronomie halal", "Marchés, tables locales certifiées, une cuisine par jour.", "food"],
  ["Nature", "Mangroves, collines, plages sauvages.", "leaf"],
  ["Photo", "Lumières du matin, spots cadrés, golden hours.", "cam"],
];
export const LEGAL = {
  mentions: ["Mentions légales", "Odyssea est une démonstration produit. Aucune réservation réelle n'est effectuée, aucun paiement n'est encaissé. Les tarifs, disponibilités et adresses affichés sont fictifs. Éditeur : Odyssea (démo). Hébergement : à renseigner avant mise en ligne."],
  confidentialite: ["Politique de confidentialité", "Les réponses données pendant la composition d'un voyage restent dans votre navigateur pendant la session et ne sont transmises à aucun tiers. Aucun compte n'est créé. Si vous utilisez l'assistant, votre question et le contexte du voyage sont envoyés au fournisseur du modèle pour produire la réponse, puis ne sont pas conservés."],
  donnees: ["Vos droits (RGPD)", "Vous disposez d'un droit d'accès, de rectification, d'effacement, de limitation, d'opposition et de portabilité. Cette démo ne conservant rien après la fermeture de l'onglet, l'effacement est immédiat. Pour toute demande, écrivez au délégué à la protection des données à l'adresse à renseigner. Vous pouvez saisir la CNIL."],
  ...
  accessibilite: ["Accessibilité", "L'interface vise le niveau AA du RGAA : contrastes vérifiés, navigation au clavier, libellés explicites, respect de « réduire les animations »."],
};
