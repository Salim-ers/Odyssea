...
export default function Packing() {
  ...
  return (
    <Screen kicker="Valise" title="Générée pour ce voyage précis."
      intro="Mousson d'octobre, mosquées, 272 marches et une mangrove au crépuscule : chaque objet a une raison d'être, elle est écrite à côté.">
      ...
      <div className="vgrid">
        ...
        <div className="card" style={{ borderColor: "rgba(240,180,60,.4)" }}>
          ...
          <ul className="oklist">
            <li><Icon name="check" />Foulard &amp; tenue modeste — visites de Masjid Negara et Masjid Jamek</li>
